...
<main>
    <div class="d-flex flex-column min-vh-100 justify-content-center align-items-center">
        <form action="testdata" method="GET" role="form">
            ...
            <h1 class="h3 mb-3 fw-normal"><fmt:message key="label.account"/>&nbsp;<fmt:message key="label.page"/></h1>
            <%--            <p class="h3 mb-3 fw-normal"><fmt:message key="label.account" /> <fmt:message key="label.page" /></p>--%>
