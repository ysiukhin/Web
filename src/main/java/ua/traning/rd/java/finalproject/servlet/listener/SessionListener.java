...
public class SessionListener implements HttpSessionListener {
    ...
    public void sessionDestroyed(HttpSessionEvent httpSessionEvent) {
        ...
        HashMap<String, LoggedAccount> loggedAccounts = (HashMap<String, LoggedAccount>) httpSessionEvent
        ...
        loggedAccounts.remove(httpSessionEvent.getSession().getId(), account);
